...
## DEC-035: Data retention baseline (MVP)
- Date: 2026-03-01
- Context: нужен формальный срок хранения операционных, security и финансовых данных.
- Decision:
  - Введена таблица сроков хранения в `docs/100_DATA_RETENTION.md`.
  - Для технических сущностей (outbox/deliveries/tokens) — короткие сроки и cleanup.
  - Для финансовых данных (`payments`, `bank_import*`) — долгий срок хранения (baseline 5 лет).
- Rationale:
